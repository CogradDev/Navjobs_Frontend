                ...
                <div>
                  ...
                  <div className="mt-2">
                    <textarea
                      ...
                      onChange={(e) => {
                        if (
                          e.target.value.split(" ").filter((n) => n !== "")
                            .length <= 250
                        ) {
          ...
          <div className="bg-white p-6 rounded w-full">
            <div className="sm:flex sm:items-start">
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                <h3 className="text-lg my-4 leading-6 font-semibold text-gray-900">
                  Filter Options
                </h3>
                <div className="mt-2">
                  <div className="mb-4">
                    ...
                    <div className="flex items-center">
                      ...
                      />
                      <label htmlFor="fullt" className="cursor-pointer">
                        Full Time
                      </label>
                    </div>
                    <div className="flex items-center">
                      ...
                      />
                      <label htmlFor="partt" className="cursor-pointer">
                        Part Time
                      </label>
                    </div>
                    <div className="flex items-center">
...
const AllJobs = () => {
  ...
  const getData = async () => {
    ...
    searchParams.push(
      `duration[gte]=0&duration[lte]=${searchOptions.duration}`
    );
