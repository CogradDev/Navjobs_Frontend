...
const Home = () => {
	const sliderDet = [
		...
		{
			name: 'MERN Developer',
			imgLink: 'https://almablog-media.s3.ap-south-1.amazonaws.com/MERN_Title_image_f86d24f764.png'
		},
		{
			name: 'Content Writer',
			imgLink:
		...
		{
			name: 'Web Designer',
			imgLink: 'https://i.pinimg.com/736x/16/77/39/16773937289929e294930bd0ab9894e3.jpg'
		},
		{
			name: 'Data Entry',
			imgLink:
					...
					<div className="mb-8 flex flex-wrap justify-between md:mb-16">
						<div className="mb-6 flex w-full flex-col justify-center sm:mb-12 lg:mb-0 lg:w-3/5 lg:pb-10 lg:pt-40">
							<h1 className="mb-4 text-4xl md:text-5xl font-bold md:mb-8 text-gray-700">
								Welcome to <span className="text-blue-600">NavJobs Portal</span> Discover
								Opportunities with NavJobs - The AI-Powered Job Portal
							</h1>

							<p className="max-w-full text-justify  text-gray-500 xl:text-lg">
								At Nav Job Portal, we are dedicated to bridging the gap between employers and job
								seekers.
							</p>
						</div>
				...
				<section className="text-gray-600 body-font">
					<div className="container px-5 py-24 mx-auto flex flex-wrap">
						<div className="flex flex-wrap -mx-4 mt-auto mb-auto lg:w-1/2 sm:w-2/3 content-start sm:pr-10">
							<div className="w-full sm:p-4 px-4 mb-6">
								<h1 className="title-font font-medium text-xl mb-2 text-gray-900">
									NavJob has successfully onboarded over 100+ talented students across various
									departments.
								</h1>
								<div className="leading-relaxed">
									This recruitment drive marks a significant milestone for our organization as we
									continue to expand and diversify our workforce.
								</div>
							</div>
						...
						<div className="lg:w-1/2 sm:w-1/3 w-full rounded-lg overflow-hidden mt-6 sm:mt-0">
							<img className="object-cover object-center w-full h-full" src={Job} alt="stats" />
						</div>
					</div>
				</section>
			</div>
