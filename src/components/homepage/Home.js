                    ...
                    <div className="mb-8 flex flex-wrap justify-between md:mb-16">
                        ...
                        <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
                            <div className="flex h-12 w-64 divide-x divide-gray-400 overflow-hidden rounded-lg border border-gray-400 relative">
                                <Link to="/login" className="flex w-1/3 items-center justify-center text-gray-500 transition duration-100 hover:bg-blue-600 hover:text-white">Login</Link>
                                <Link to="/applicantsignup" className="flex w-1/3 items-center justify-center text-gray-500 transition duration-100 hover:bg-blue-600 hover:text-white">Signup</Link>
                                <Link to="/" className="flex w-1/3 items-center justify-center text-gray-500 transition duration-100 hover:bg-blue-600 hover:text-white">About</Link>
                            </div>
                        </div>
                    </div>
                ...
                <footer class="mx-auto max-w-screen-2xl px-4 md:px-8">
                    <div class="flex flex-col items-center justify-between gap-4 border-t border-blue-400 rounded-md border-b py-6 md:flex-row">
                        <nav class="flex flex-wrap justify-center gap-x-4 gap-y-2 md:justify-start md:gap-6">
                            <Link to="/" class="text-gray-500 transition duration-100 hover:text-blue-700 hover:scale-105">About</Link>
                            <Link to="/" class="text-gray-500 transition duration-100 hover:text-blue-700 hover:scale-105">Investor Relations</Link>
                            <Link to="/" class="text-gray-500 transition duration-100 hover:text-blue-700 hover:scale-105">Jobs</Link>
                            <Link to="/" class="text-gray-500 transition duration-100 hover:text-blue-700 hover:scale-105">Press</Link>
                            <Link to="/" class="text-gray-500 transition duration-100 hover:text-blue-700 hover:scale-105">Blog</Link>
                        </nav>
                        
                        <div class="flex gap-4">
                            <Link to="/" target="_blank" class="text-gray-400 transition duration-100 hover:text-pink-500 active:text-gray-600">
                            ...
                            <Link to="/" target="_blank" class="text-gray-400 transition duration-100 hover:text-blue-500 active:text-gray-600">
                                <svg class="h-5 w-5" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z" />
                                </svg>
                            </Link>

                            <Link to="/" target="_blank" class="text-gray-400 transition duration-100 hover:text-blue-700 active:text-gray-600">
                                <svg class="h-5 w-5" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
                                </svg>
                            </Link>

                            <Link to="/" target="_blank" class="text-gray-400 transition duration-100 hover:text-gray-700 active:text-gray-600">
                                <svg class="h-5 w-5" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="py-8 text-center text-sm text-blue-700"><span className='text-gray-700'>©</span> 2024 - NavJobs. All rights reserved.</div>
                </footer>
            </div>
