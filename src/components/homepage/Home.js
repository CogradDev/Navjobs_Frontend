        ...
        <div className="flex flex-col">
          <div className="flex flex-col lg:flex-row items-center">
            ...
            <div className="border border-gray-400 relative m-4 p-4 h-56 w-full rounded-xl bg-gradient-to-t from-green-200">
              ...
              <Link
                to="/"
                class="absolute bottom-12 left-4 border border-gray-400 px-1.5 text-sm py-1 rounded-lg bg-green-500 hover:bg-green-600 text-white group transition ease-in-out duration-200"
              >
                See More{" "}
                <span
                  aria-hidden="true"
            ...
            <div className="border border-gray-400 relative m-4 p-4 h-56 w-full rounded-xl bg-gradient-to-t from-red-200">
              ...
              <Link
                to="/"
                class="absolute bottom-12 left-4 border border-gray-400 px-1.5 text-sm py-1 rounded-lg bg-red-500 hover:bg-red-600 text-white group transition ease-in-out duration-200"
              >
                See More{" "}
                <span
                  aria-hidden="true"
          ...
          <div className="flex flex-col lg:flex-row items-center">
            <div className="border border-gray-400 relative m-4 p-4 h-56 w-full rounded-xl bg-gradient-to-t from-cyan-200">
              ...
              <Link
                to="/"
                class="absolute bottom-12 left-4 border border-gray-400 px-1.5 text-sm py-1 rounded-lg bg-cyan-500 hover:bg-cyan-600 text-white group transition ease-in-out duration-200"
              >
                See More{" "}
                <span
                  aria-hidden="true"
            ...
            <div className="border border-gray-400 relative m-4 p-4 h-56 w-full rounded-xl bg-gradient-to-t from-purple-200">
              ...
              <Link
                to="/"
                class="absolute bottom-12 left-4 border border-gray-400 px-1.5 text-sm py-1 rounded-lg bg-purple-500 hover:bg-purple-600 text-white group transition ease-in-out duration-200"
              >
                See More{" "}
                <span
                  aria-hidden="true"
            ...
            <div className="border border-gray-400 relative m-4 p-4 h-56 w-full rounded-xl bg-gradient-to-t from-orange-200">
              ...
              <Link
                to="/"
                class="absolute bottom-12 left-4 border border-gray-400 px-1.5 text-sm py-1 rounded-lg bg-orange-500 hover:bg-orange-600 text-white group transition ease-in-out duration-200"
              >
                See More{" "}
                <span
                  aria-hidden="true"
